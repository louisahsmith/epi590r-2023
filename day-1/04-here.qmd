...
4.  Download the `.R` script [here](https://github.com/louisahsmith/epi590r-in-class/blob/db030e9d10e6deb5658a4dddf52542bbc4b0a488/R/clean-data-good.R) and use your file browser to put it in the R folder in your project. Open the script and run through the code line-by-line. Compare it with the code from the last section.
