...
3.  Look at the git pane. What do you notice compared to [the first time](day-1/02-github.qmd#Exercises) we looked at this pane? Stage and commit the files (I usually use "initial commit" as my first commit message since I haven't don't anything yet!). You'll notice the "Push" button is grayed out -- we'll have to fix that!
...
8.  Create a new file called `secret.txt` (you can do this via File \> New File \> Text file, then save the file). Write down your deepest, darkest secrets in there.
